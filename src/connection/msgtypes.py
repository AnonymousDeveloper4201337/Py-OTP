...
MsgDirectorTypes = invertDictLossless(stateServer)
globals().update(stateServer)
...
MsgDirectorTypes = invertDictLossless(databaseServer)
globals().update(databaseServer)